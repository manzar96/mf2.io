...
const LeaderboardSection = () => {
  const leaderboardData = [
    { rank: '👤', model: 'Human Baseline', parameters: '—', openSource: null, videoTranscript: 90.5, videoOnly: null, isHuman: true },
    ...
    { rank: 9, model: 'Qwen3-VL-IT', parameters: '30B', openSource: true, videoTranscript: 42.3, videoOnly: 19.2 },
    ...
    { rank: 15, model: 'Aria', parameters: '25B', openSource: true, videoTranscript: 33.41, videoOnly: 2.53 },
