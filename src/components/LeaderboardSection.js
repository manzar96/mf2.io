...
const LeaderboardSection = () => {
  const leaderboardData = [
    ...
    { rank: 7, model: 'Gemma3', parameters: '27B', openSource: true, videoTranscript: 42.9, videoOnly: 31.5 },
    { rank: 8, model: 'Qwen3VL-IT', parameters: '30B', openSource: true, videoTranscript: 42.3, videoOnly: 19.2 },
    { rank: 9, model: 'LLaVA-Video', parameters: '72B', openSource: true, videoTranscript: 41.8, videoOnly: 15.6 },
    { rank: 10, model: 'MiMo-VL-7B-RL', parameters: '7B', openSource: true, videoTranscript: 38.59, videoOnly: 25.81 },
    { rank: 11, model: 'InternVL3', parameters: '8B', openSource: true, videoTranscript: 36.9, videoOnly: 10.9 },
    { rank: 12, model: 'GLM-4.5V-FP8', parameters: '108B', openSource: true, videoTranscript: 35.59, videoOnly: null },
    { rank: 13, model: 'VideoLLaMA3', parameters: '7B', openSource: true, videoTranscript: 33.5, videoOnly: 20.5 },
    { rank: 14, model: 'Aria', parameters: '25B(3.9B)', openSource: true, videoTranscript: 33.41, videoOnly: 2.53 },
    { rank: 15, model: 'Qwen2.5-VL', parameters: '7B', openSource: true, videoTranscript: 32.8, videoOnly: 24.6 },
    { rank: 16, model: 'LLaVA-OneVision1.5', parameters: '8B', openSource: true, videoTranscript: 26.4, videoOnly: 4.9 },
    { rank: 17, model: 'LLaVA-Video', parameters: '7B', openSource: true, videoTranscript: 19.0, videoOnly: 6.6 },
    { rank: 18, model: 'LongVILA-R1', parameters: '7B', openSource: true, videoTranscript: 16.9, videoOnly: 11.5 },
    { rank: 19, model: 'mPLUG-Owl3', parameters: '7B', openSource: true, videoTranscript: null, videoOnly: null, hasAsterisk: true },
    { rank: 20, model: 'Kangaroo', parameters: '8B', openSource: true, videoTranscript: null, videoOnly: null, hasAsterisk: true },
  ];
